...
///////右键删除菜单
	    ...
	    del.addActionListener(new ActionListener(){
	    	public void actionPerformed(ActionEvent e){
	    		...
	    		try {
					TagDeal.delTag(tags,selectedtagcla,selectedtag,"TagMerge.txt");
	    ...
	    public void mouseClicked(MouseEvent e) {
	        if (SwingUtilities.isLeftMouseButton(e)) {
	        	...
	        	//如果已经选取了某一评论
	        	{
	        		...
	        		try {
						TagDeal.addID(tags,(String)selectedtagcla,(String)taglist.getSelectedValue(), selectedID,"TagMerge.txt");
					} catch (IOException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
		...
		public void actionPerformed(ActionEvent e) {
			if( !tct.getText().trim().equals("")&& !tt.getText().trim().equals("")) {
				...
				if(flag==0) {
					...
					try {
						TagDeal.createTags(tags,tct.getText(),tt.getText(),"TagMerge.txt");
					} catch (IOException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
